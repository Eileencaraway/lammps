...
class Atom : protected Pointers {
 public:
  ...
  // added for run and tumble motion
  double **Ft; // force applied to impose the torque on the molecule
  int *state, *t_transition, *t_elapsed; // state (0=running, 1= tumbling), time of next transition, time from last transition
