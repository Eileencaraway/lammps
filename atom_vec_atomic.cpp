...
void AtomVecAtomic::grow(int n)
{
  ...
  Ft = memory->grow(atom->Ft,nmax,3,"atom:Ft");
  state = memory->grow(atom->state,nmax,"atom:state");
  t_transition = memory->grow(atom->t_transition,nmax,"atom:t_transition");
  t_elapsed = memory->grow(atom->t_elapsed,nmax,"atom:t_elapsed");
